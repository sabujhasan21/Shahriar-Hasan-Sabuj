...
def digital_id_page():
    ...
    <style>
    body {margin:0; height:100vh; background: linear-gradient(-45deg,#e3f2fd,#bbdefb,#e1f5fe,#cfd8dc); background-size:400% 400%; animation: gradientBG 12s ease infinite; font-family: 'Segoe UI', sans-serif;}
    @keyframes gradientBG {0%{background-position:0% 50%;}50%{background-position:100% 50%;}100%{background-position:0% 50%;}}

    .profile-card {background:white; width:60%; margin:120px auto; padding:45px 55px; border-radius:16px; box-shadow:0 15px 40px rgba(0,0,0,0.18); opacity:0; transform:translateY(40px); animation: cardIn 1.2s ease forwards;}
    ...
    .designation {font-size:18px; color:black; margin:10px 0 25px; opacity:0; animation: fadeIn 1s ease forwards; animation-delay:2.8s;}
